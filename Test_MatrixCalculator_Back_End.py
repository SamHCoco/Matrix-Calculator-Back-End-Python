...
class TestMatrixCalculator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.matrix1 = Matrix(3, 3, "A(3x3)")
        self.matrix1.matrix = [[1.11, 2.22, -3.338],
                               [4.44, 5.55,  -6],
                               [0,    7.77,  -8.88]]
        # 2x2 matrix test case
        self.matrix2 = Matrix(2, 2, "B(2x2)")
        self.matrix2.matrix = [[1.111, 2.222],
                               [3.333, -4.444]]
    ...
    def test_add(self):
        ...
        expected_result = [[2.22,  4.44,  -6.676],
                           [8.88, 11.1, -12.0],
                           [0, 15.54, -17.76]]
        self.assertEqual(self.matrix1.add(self.matrix1), expected_result)
    ...
    def test_scalar_multiply(self):
        ...
        expected_result = [[3.33,  6.66,  -10.014],
                           [13.32, 16.65, -18],
                           [0,     23.31, -26.64]]
        self.assertEqual(self.matrix1.scalar_multiply(3), expected_result)
    ...
    def test_multiply(self):
        ...
        self.assertEqual(self.matrix1.multiply(self.matrix1), expected_result)

    def test_find_determinant(self):
        """Test finding 3x3 and 2x2 matrix determinant."""
        # 3x3 case
        self.assertEqual(self.matrix1.find_determinant(), -30.586)
        # 2x2 case
        self.assertEqual(self.matrix2.find_determinant(), -12.343)

    def test_find_matrix_size(self):
        """Test finding matrix size."""
        self.assertEqual(self.matrix1.find_matrix_size(), 3)
        matrix = Matrix(4, 4, "C")
